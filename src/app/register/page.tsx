...
export default function SignupPage() {
  ...
  return (
    <div className="container mx-auto mt-6 flex items-center justify-center min-h-[calc(100vh-200px)]">
      <div className="w-full max-w-md bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden">
        <div className="p-6 border-b border-gray-200 dark:border-gray-700">
          <h2 className="text-2xl font-bold">Create an account</h2>
          <p className="text-gray-600 dark:text-gray-400 text-sm mt-1">Enter your information to create an account</p>
        </div>
